...
def home_page():
    ...
    #######################################################################################################################################
    train_df_sorted = load_data('train_df_sorted.csv')
    test_df_sorted = load_data('test_df_sorted.csv')
    player_df = load_data('player_df.csv')
    field_df = load_data('field_df.csv')
...
def stats_page():
    ...
    total_df_sorted = load_data('total_df_sorted.csv')
